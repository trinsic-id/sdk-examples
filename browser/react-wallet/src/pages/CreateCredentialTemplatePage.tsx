          ...
          <div className="w-full shadow-lg box-border border-2">
            ...
            <form onSubmit={this.submit.bind(this)}>
              <div className="px-2">
                ...
                <Input className="w-5/6" name="templateName" value={this.state.name}
...
function mapDispatchToProps(dispatch: Dispatch) {
  return {
    createTemplate: (name: string, fields: { [key: string]: TemplateField; }) => createCredentialTemplate(name, fields)
  }
}
