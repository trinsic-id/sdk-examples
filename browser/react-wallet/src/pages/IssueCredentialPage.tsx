...
import {ActionState, OnChangeType} from "../types";
            ...
            <div className="flex gap-4 flex-col lg:flex-row">
                ...
                <div className="rounded w-full lg:w-1/2 p-6 bg-white shadow">
                    ...
                    <div className="flex gap-2 w-full justify-end text-sm md:text-base lg:text-lg mt-4">
                        <Button variant="outline" className="w-1/2" onClick={this.copyToClipboard.bind(this)}>Copy to
                            clipboard</Button>
                ...
                <Toast className="z-50" color="green" show={this.state.emailSent}
                       onClose={this.props.closeNotification}>Credential Sent to Wallet! :)</Toast>
...
function mapDispatchToProps(dispatch: ThunkDispatch<ActionState, undefined, any>) {
    return {
        ...
        issueCredential: (templateId: string, fields: any) => dispatch(issueCredential(templateId, fields)),
        sendToWallet: (credential: any, email: string) => dispatch(sendCredential(credential, email)),
